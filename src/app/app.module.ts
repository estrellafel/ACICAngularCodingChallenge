...
import { QuotesFrequencyComponent } from './quote-frequency/quote-frequency.component'; // Allow new component for use
...
@NgModule({
  ...
  declarations: [
    ...
    MessagesComponent,
    QuotesFrequencyComponent // Added the new component
  ],
